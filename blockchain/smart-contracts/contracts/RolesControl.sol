...
contract RolesControl{
    ...
    function IsUserValid (string memory _Address,string memory _CID,string memory _metaDataCID,string memory _user,uint _startingRow,uint _endingRow,string memory _column) public view returns(bool){
    ...
    function addDataProvider(
      string memory _Address,string memory _CID,string memory _metaDataCID,string[] memory _users,uint _startingRow,uint _endingRow,string[] memory _columns) public {
